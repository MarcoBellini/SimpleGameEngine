...
Namespace Direct2D
    ...
    Public Interface ID2D1RenderTarget
        ...
        ''' </summary>
        Function CreateBitmap(<MarshalAs(UnmanagedType.Struct)> ByVal size As D2D1_SIZE_U,
        ...
        ''' </summary>
        Function CreateBitmapFromWicBitmap(<[In](), MarshalAs(UnmanagedType.Interface)> ByVal wicBitmapSource As IWICBitmapSource,
                                           <[In](), MarshalAs(UnmanagedType.Struct)> ByRef bitmapProperties As D2D1_BITMAP_PROPERTIES,
                                           <Out(), MarshalAs(UnmanagedType.Interface)> ByRef bitmap As ID2D1Bitmap) As HRESULT
        ...
        ''' </summary>
        Function CreateSharedBitmap(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef riid As Guid,
        ...
        ''' Or pen a geometry.
        ''' </summary>
        Function CreateBitmapBrush(<[In](), MarshalAs(UnmanagedType.Interface)> ByRef bitmap As ID2D1Bitmap,
        ...
        '    ) PURE;
        Function CreateSolidColorBrush(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef color As D2D1_COLOR_F,
                                       <[In](), MarshalAs(UnmanagedType.Struct)> ByRef brushProperties As D2D1_BRUSH_PROPERTIES,
        ...
        Function CreateGradientStopCollection(<[In](), MarshalAs(UnmanagedType.LPArray)> ByVal color() As D2D1_GRADIENT_STOP,
        ...
        '    ) PURE;
        Function CreateLinearGradientBrush(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef linearGradientBrushProperties As D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES,
                                           <[In](), MarshalAs(UnmanagedType.Struct)> ByRef brushProperties As D2D1_BRUSH_PROPERTIES,
        ...
        '    ) PURE;
        Function CreateRadialGradientBrush(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef radialGradientBrushProperties As D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES,
                                           <[In](), MarshalAs(UnmanagedType.Struct)> ByRef brushProperties As D2D1_BRUSH_PROPERTIES,
                                           <[In](), MarshalAs(UnmanagedType.Interface)> ByVal gradientStopCollection As ID2D1GradientStopCollection,
        ...
        Function CreateCompatibleRenderTarget(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef desiredSize As D2D1_SIZE_F,
        ...
        Function CreateLayer(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef size As D2D1_SIZE_F,
        ...
        ''' Create a D2D mesh.
        ''' </summary>
        Function CreateMesh(<Out(), MarshalAs(UnmanagedType.Interface)> ByRef mesh As ID2D1Mesh) As HRESULT
        ...
        '    ) PURE;
        Sub DrawLine(<MarshalAs(UnmanagedType.Struct)> ByVal point0 As D2D1_POINT_2F,
        ...
        '    _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL 
        '    ) PURE;
        Sub DrawRectangle(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef rect As D2D1_RECT_F,
                         <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush,
                         Optional ByVal strokeWidth As Single = 1.0F,
                         <[In](), MarshalAs(UnmanagedType.Interface)> Optional ByVal strokeStyle As ID2D1StrokeStyle = Nothing)
        ...
        '    _In_ ID2D1Brush *brush 
        '    ) PURE;
        Sub FillRectangle(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef rect As D2D1_RECT_F,
                          <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush)
        ...
        '    _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL 
        '    ) PURE;
        Sub DrawRoundedRectangle(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef roundedRect As D2D1_ROUNDED_RECT,
                                 <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush,
                                 Optional ByVal strokeWidth As Single = 1.0F,
                                 <[In](), MarshalAs(UnmanagedType.Interface)> Optional ByVal strokeStyle As ID2D1StrokeStyle = Nothing)
        ...
        '    _In_ ID2D1Brush *brush 
        '    ) PURE;
        Sub FillRoundedRectangle(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef roundedRect As D2D1_ROUNDED_RECT,
                                 <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush)
        ...
        '    _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL 
        '    ) PURE;
        Sub DrawEllipse(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef ellipse As D2D1_ELLIPSE,
                        <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush,
                        Optional ByVal strokeWidth As Single = 1.0F,
                        <[In](), MarshalAs(UnmanagedType.Interface)> Optional ByVal strokeStyle As ID2D1StrokeStyle = Nothing)
        ...
        '    _In_ ID2D1Brush *brush 
        '    ) PURE;
        Sub FillEllipse(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef ellipse As D2D1_ELLIPSE,
                        <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush)
        ...
        '    _In_opt_ ID2D1StrokeStyle *strokeStyle = NULL 
        '    ) PURE;
        Sub DrawGeometry(<[In](), MarshalAs(UnmanagedType.Interface)> ByVal geometry As ID2D1Geometry,
                        <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush,
                        Optional ByVal strokeWidth As Single = 1.0F,
                        <[In](), MarshalAs(UnmanagedType.Interface)> Optional ByVal strokeStyle As ID2D1StrokeStyle = Nothing)
        ...
        Sub FillGeometry(<[In](), MarshalAs(UnmanagedType.Interface)> ByVal geometry As ID2D1Geometry,
                         <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush,
        ...
        ''' </summary>
        Sub FillMesh(<[In](), MarshalAs(UnmanagedType.Interface)> ByVal mesh As ID2D1Mesh,
                     <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush)
        ...
        ''' be set to aliased.
        ''' </summary>
        Sub FillOpacityMask(<[In](), MarshalAs(UnmanagedType.Interface)> ByVal opacityMask As ID2D1Bitmap,
                            <[In](), MarshalAs(UnmanagedType.Interface)> ByVal brush As ID2D1Brush,
        ...
        '    _In_opt_ Const D2D1_RECT_F *sourceRectangle = NULL 
        '    ) PURE;
        Sub DrawBitmap(<[In](), MarshalAs(UnmanagedType.Interface)> ByVal bitmap As ID2D1Bitmap,
                       <[In](), MarshalAs(UnmanagedType.Struct)> Optional ByRef destinationRectangle As D2D1_RECT_F = Nothing,
        ...
        ''' baseline snapping.
        ''' </summary>
        Sub DrawText(<[In](), MarshalAs(UnmanagedType.LPWStr)> ByVal str As String,
        ...
        ''' </param>
        Sub DrawTextLayout(<MarshalAs(UnmanagedType.Struct)> ByVal origin As D2D1_POINT_2F,
        ...
        Sub DrawGlyphRun(<MarshalAs(UnmanagedType.Struct)> ByVal baselineOrigin As D2D1_POINT_2F,
        ...
        '    ) CONST PURE;       
        Sub GetTransform(<Out(), MarshalAs(UnmanagedType.Struct)> ByRef transform As D2D1_MATRIX_3X2_F)
        ...
        '    ) PURE;
        Sub SetTextRenderingParams(<[In](), MarshalAs(UnmanagedType.Interface)> Optional ByVal textRenderingParams As IDWriteRenderingParams = Nothing)
        ...
        ''' </summary>
        Sub GetTextRenderingParams(<Out(), MarshalAs(UnmanagedType.Interface)> ByVal textRenderingParams As IDWriteRenderingParams)
        ...
        ''' </summary>
        Sub SetTags(ByVal tag1 As UInt64,
        ...
        ''' </summary>
        Sub GetTags(Optional ByRef tag1 As UInt64 = Nothing,
        ...
        ''' </summary>
        Sub PushLayer(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef layerParameters As D2D1_LAYER_PARAMETERS)
        ...
        '    _Out_opt_ D2D1_TAG *tag2 = NULL 
        '    ) PURE;
        Sub Flush(Optional ByRef tag1 As UInt64 = Nothing,
                  Optional ByRef tag2 As UInt64 = Nothing)
        ...
        ''' IDrawingStatckBlock.
        ''' </summary>
        Sub SaveDrawingState(<[In](), Out(), MarshalAs(UnmanagedType.Interface)> ByVal drawingStateBlock As ID2D1DrawingStateBlock)
        ...
        ''' </summary>
        Sub RestoreDrawingState(<[In](), MarshalAs(UnmanagedType.Interface)> ByVal drawingStateBlock As ID2D1DrawingStateBlock)
        ...
        ''' </summary>
        Sub PushAxisAlignedClip(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef clipRect As D2D1_RECT_F,
        ...
        '    ) PURE;
        Sub Clear(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef clearColor As D2D1_COLOR_F)
        ...
        ''' </summary>
        Sub EndDraw(Optional ByRef p1 As UInt64 = Nothing,
        ...
        ''' </summary>
        Sub SetDpi(ByVal dpiX As Single,
        ...
        ''' </summary>
        Sub GetDpi(<Out()> ByRef dpiX As Single,
        ...
        ''' </summary>
        Function GetMaximumBitmapSize() As UInt32
        ...
        ''' supported.
        ''' </summary>
        Function IsSupported(<[In](), MarshalAs(UnmanagedType.Struct)> ByRef renderTargetProperties As D2D1_RENDER_TARGET_PROPERTIES) As <MarshalAs(UnmanagedType.Bool)> Boolean
